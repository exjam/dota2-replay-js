...
var LITERAL         = 0
  ...
  , twoByteCopy = function() {
      var length = (this.input[this.inputPtr] >> 2) + 1
        , offset = this.input[this.inputPtr + 1]
                 | this.input[this.inputPtr + 2] << 8;
  ...
  , fourByteCopy = function() {
      var length = (this.input[this.inputPtr] >> 2) + 1
        , offset = this.input[this.inputPtr + 1]
                 | this.input[this.inputPtr + 2] << 8
                 | this.input[this.inputPtr + 3] << 16
                 | this.input[this.inputPtr + 4] << 24;
  ...
  , Uncompress = function(input) {
      ...
      this.output = new Uint8Array(uncompressedLength(input))
      this.outputPtr = 0
